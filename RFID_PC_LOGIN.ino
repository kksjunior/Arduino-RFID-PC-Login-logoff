...
//                                                                               //
//                                                                               //
// Arduino code to login/logoff windows using Arduino and MFRC522 RFID Module    //
//                                                                               //
// Coded by kksjunior (w!z)                                                      //
...
void loop( ) 
{
 ...
 { 
  ...
  delay (300) ;
  Keyboard. print ("3632") ;                 // Change this value to your Windows PIN/Password.
  Keyboard. releaseAll ( ) ;
  delay ( 200 ) ;
